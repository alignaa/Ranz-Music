...
__MODULE__ = "ɪɴғᴏ"
__HELP__ = """
<b>ᴜꜱᴇʀ & ᴄʜᴀᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ:</b>

`/info`: ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ᴜꜱᴇʀ. ᴜꜱᴇʀɴᴀᴍᴇ, ɪᴅ, ᴀɴᴅ ᴍᴏʀᴇ.
`/chatinfo [ᴜsᴇʀɴᴀᴍᴇ|ɪᴅ]`: ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ᴄʜᴀᴛ. ᴍᴇᴍʙᴇʀ ᴄᴏᴜɴᴛ, ɪꜱ ᴠᴇʀɪғɪᴇᴅ, ɪɴᴠɪᴛᴇ ʟɪɴᴋ, ᴀɴᴅ ᴍᴏʀᴇ.
"""
