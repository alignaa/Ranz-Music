...
__MODULE__ = "ᴛʀᴜᴛʜ"
__HELP__ = """
ᴛʀᴜᴛʜ ᴏʀ ᴅᴀʀᴇ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ
ᴜꜱᴇ ᴛʜᴇꜱᴇ ᴄᴏᴍᴍᴀɴᴅꜱ ᴛᴏ ᴘʟᴀʏ ᴛʀᴜᴛʜ ᴏʀ ᴅᴀʀᴇ:

- `/truth`: ɢᴇᴛ ᴀ ʀᴀɴᴅᴏᴍ ᴛʀᴜᴛʜ ǫᴜᴇꜱᴛɪᴏɴ. ᴀɴꜱᴡᴇʀ ʜᴏɴᴇꜱᴛʟʏ!
...
<b>ɴᴏᴛᴇ:</b>
ɪғ ʏᴏᴜ ᴇɴᴄᴏᴜɴᴛᴇʀ ᴀɴʏ ɪꜱꜱᴜᴇꜱ ᴡɪᴛʜ ғᴇᴛᴄʜɪɴɢ ǫᴜᴇꜱᴛɪᴏɴꜱ, ᴘʟᴇᴀꜱᴇ ᴛʀʏ ᴀɢᴀɪɴ ʟᴀᴛᴇʀ.
"""
