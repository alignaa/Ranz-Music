...
__HELP__ = """
ǫᴜᴏᴛᴇ ɢᴇɴᴇʀᴀᴛɪᴏɴ
ᴜꜱᴇ ᴛʜᴇꜱᴇ ᴄᴏᴍᴍᴀɴᴅꜱ ᴛᴏ ᴄʀᴇᴀᴛᴇ ǫᴜᴏᴛᴇꜱ ғʀᴏᴍ ᴍᴇꜱꜱᴀɢᴇꜱ:

- `/q`: ᴄʀᴇᴀᴛᴇ ᴀ ǫᴜᴏᴛᴇ ғʀᴏᴍ ᴀ ꜱɪɴɢʟᴇ ᴍᴇꜱꜱᴀɢᴇ.
- `/r`: ᴄʀᴇᴀᴛᴇ ᴀ ǫᴜᴏᴛᴇ ғʀᴏᴍ ᴀ ꜱɪɴɢʟᴇ ᴍᴇꜱꜱᴀɢᴇ ᴀɴᴅ ɪᴛꜱ ʀᴇᴘʟɪᴇᴅ ᴍᴇꜱꜱᴀɢᴇ.

<b>ᴇxᴀᴍᴘʟᴇꜱ:</b>
- `/q `: ᴄʀᴇᴀᴛᴇ ᴀ ǫᴜᴏᴛᴇ ғʀᴏᴍ ʀᴇᴘʟɪᴇᴅ ᴍᴇꜱꜱᴀɢᴇꜱ.
- `/r `: ᴄᴄʀᴇᴀᴛᴇ ᴀ ǫᴜᴏᴛᴇ ғʀᴏᴍ ʀᴇᴘʟɪᴇᴅ ᴍᴇꜱꜱᴀɢᴇꜱ.

<b>ɴᴏᴛᴇ:</b>
ᴍᴀᴋᴇ ꜱᴜʀᴇ ᴛᴏ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇꜱꜱᴀɢᴇ ғᴏʀ ᴛʜᴇ ǫᴜᴏᴛᴇ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ᴡᴏʀᴋ.
"""
