...
__MODULE__ = "ᴘʀᴇᴛᴇɴᴅᴇʀ"
__HELP__ = """
/pretender - [ᴏɴ / ᴏғғ]  - ᴛᴏ ᴛᴜʀɴ ᴏɴ ᴏʀ ᴏғғ ᴘʀᴇᴛᴇɴᴅᴇʀ ғᴏʀ ʏᴏᴜ ᴄʜᴀᴛ ɪғ ᴀɴʏ ᴜꜱᴇʀ ᴄʜᴀɴɢᴇ ʜᴇʀ ᴜꜱᴇʀɴᴀᴍᴇ, ɴᴀᴍᴇ , ʙɪᴏ ʙᴏᴛ ᴡɪʟʟ ꜱᴇɴᴅ ᴍᴇꜱꜱᴀɢᴇ ɪɴ ʏᴏᴜʀ ᴄʜᴀᴛ"""
