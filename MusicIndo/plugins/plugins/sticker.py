...
• /stickerid - ɢᴇᴛꜱ ᴛʜᴇ ғɪʟᴇ ɪᴅ ᴏғ ᴀɴʏ ʀᴇᴘʟɪᴇᴅ ꜱᴛɪᴄᴋᴇʀ.
• /getsticker - ɢᴇᴛꜱ ᴛʜᴇ ɪᴍᴀɢᴇ ᴏғ ᴀɴʏ ʀᴇᴘʟɪᴇᴅ ꜱᴛɪᴄᴋᴇʀ.
• /kang - ᴋᴀɴɢꜱ ᴀɴʏ ꜱᴛɪᴄᴋᴇʀ ɪɴ ᴛʜᴇ ʏᴏᴜ ᴘᴀᴄᴋ

<b>ɴᴏᴛᴇ:</b>
- ᴛʜɪꜱ ʙᴏᴛ ᴀʟʟᴏᴡꜱ ᴜꜱᴇʀꜱ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ғɪʟᴇ ɪᴅ ᴏʀ ᴛʜᴇ ɪᴍᴀɢᴇ ᴏғ ᴀɴʏ ꜱᴛɪᴄᴋᴇʀ ᴛʜᴀᴛ ɪꜱ ʀᴇᴘʟɪᴇᴅ ᴛᴏ ᴀ ᴍᴇꜱꜱᴀɢᴇ, ᴀɴᴅ ᴀʟꜱᴏ ᴀʟʟᴏᴡꜱ ᴜꜱᴇʀꜱ ᴛᴏ ᴋᴀɴɢ ᴀɴʏ ꜱᴛɪᴄᴋᴇʀ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ ᴀɴᴅ ᴀᴅᴅ ɪᴛ ᴛᴏ ᴀ ꜱᴛɪᴄᴋᴇʀ ᴘᴀᴄᴋ.
"""
