...
from MusicIndo.utils.decorators.play import PlayWrapper
from MusicIndo.utils.formatters import formats
...
from MusicIndo.utils.inline.playlist import botplaylist_markup
from MusicIndo.utils.logger import play_logs
...
__MODULE__ = "ᴘʟᴀʏ"
__HELP__ = """<b>✅<u>ᴘʟᴀʏ ᴄᴏᴍᴍᴀɴᴅꜱ:</u></b>
ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅꜱ = <code>play , vplay , cplay</code>
ꜰᴏʀᴄᴇᴘʟᴀʏ ᴄᴏᴍᴍᴀɴᴅꜱ = <code>playforce , vplayforce , cplayforce</code>

ᴄ ꜱᴛᴀɴᴅꜱ ғᴏʀ ᴄʜᴀɴɴᴇʟ ᴘʟᴀʏ.
ᴠ ꜱᴛᴀɴᴅꜱ ғᴏʀ ᴠɪᴅᴇᴏ ᴘʟᴀʏ.
ꜰᴏʀᴄᴇ ꜱᴛᴀɴᴅꜱ ғᴏʀ ғᴏʀᴄᴇ ᴘʟᴀʏ.

/play ᴏʀ /vplay ᴏʀ /cplay - ʙᴏᴛ ᴡɪʟʟ ꜱᴛᴀʀᴛ ᴘʟᴀʏɪɴɢ ʏᴏᴜʀ ɢɪᴠᴇɴ ǫᴜᴇʀʏ ᴏɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴏʀ ꜱᴛʀᴇᴀᴍ ʟɪᴠᴇ ʟɪɴᴋꜱ ᴏɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛꜱ.
/playforce ᴏʀ /vplayforce ᴏʀ /cplayforce -  ꜰᴏʀᴄᴇ ᴘʟᴀʏ ꜱᴛᴏᴘꜱ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴘʟᴀʏɪɴɢ ᴛʀᴀᴄᴋ ᴏɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴀɴᴅ ꜱᴛᴀʀᴛꜱ ᴘʟᴀʏɪɴɢ ᴛʜᴇ ꜱᴇᴀʀᴄʜᴇᴅ ᴛʀᴀᴄᴋ ɪɴꜱᴛᴀɴᴛʟʏ ᴡɪᴛʜᴏᴜᴛ ᴅɪꜱᴛᴜʀʙɪɴɢ/ᴄʟᴇᴀʀɪɴɢ ǫᴜᴇᴜᴇ.
/channelplay [ᴄʜᴀᴛ ᴜꜱᴇʀɴᴀᴍᴇ ᴏʀ ɪᴅ] ᴏʀ [ᴅɪꜱᴀʙʟᴇ] - ᴄᴏɴɴᴇᴄᴛ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴀ ɢʀᴏᴜᴘ ᴀɴᴅ ꜱᴛʀᴇᴀᴍ ᴍᴜꜱɪᴄ ᴏɴ ᴄʜᴀɴɴᴇʟ'ꜱ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ғʀᴏᴍ ʏᴏᴜʀ ɢʀᴏᴜᴘ.
"""
